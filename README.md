...
- **![Python Badge](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white) Python 3**: Motor por de trás de toda a raspagem.
...
- **![Dart Badge](https://img.shields.io/badge/Dart-0175C2?style=flat&logo=dart&logoColor=white) Dart / ![Flutter Badge](https://img.shields.io/badge/Flutter-02569B?style=flat&logo=flutter&logoColor=white) Flutter**: Construção moderna de UI que roda sem engasgos nos dispostivos alvo.
